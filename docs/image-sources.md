...
The photographic cards in the “Wybierz obszar” homepage section use locally
stored WebP variants. The photos are free to use under the
...
from landing-page photography in `public/images/specialization-cards/`.
