          ...
          return (
            <li key={item.id}>
              <Link
                ...
                className="flex min-h-14 flex-col items-center justify-center gap-1 rounded-sm text-[11px] text-text-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-action/50 aria-[current=page]:text-action"
                onClick={() =>
